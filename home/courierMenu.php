...
<head>
    ...
    <style>
        body {
            background-image: url(https://img.freepik.com/free-photo/high-angle-delivery-truck-boxes_23-2148790062.jpg?w=1480&t=st=1709276981~exp=1709277581~hmac=bd26be78bc8d0e168deacb8d706711b6807834f58b9d4f90b41bc4718317668a);
    ...
    <form action="courierMenu.php" method="POST" enctype="multipart/form-data">
        <div style="overflow-x:auto;">
            <table border="0px solid" style="margin: auto; font-weight:bold;border-spacing: 5px 15px;">
                <th colspan="4" style="text-align: center; width: 140px; height: 50px;">Fill The Details Of Sender & Receiver</th>
                <tr>
                ...
                <tr>
                    <td colspan="4">__________________________________________________________________________</td>
                </tr>
                <tr>
                    <td>Weight:</td>
